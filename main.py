...
try:
    while True:
        ...
        while True:
            if selected_fetch == 1:
                ...
                print("\033]8;;https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens\033\\Visit this website.\033]8;;\033\\")
    ...
    print("Please report this issue with the above error message to GitHub 'Akeoots/GitHub-Activity-Fetcher'.")
